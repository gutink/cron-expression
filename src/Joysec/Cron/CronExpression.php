...
class CronExpression
{
    ...
    protected $leastParts = 6;
    protected static $minPosition = self::SECOND;
     ...
     */
    protected $maxIterationCount = 10000;
     ...
     * @see \Joysec\Cron\CronExpression::factory
     */
    ...
    public function setExpression($value)
    {
        ...
        if (count($this->cronParts) < $this->leastParts) {
     ...
     * @return \DateTime
     * @throws \RuntimeException on too many iterations
     * @see \Joysec\Cron\CronExpression::getNextRunDate
     */
...
//            $timeZone = date_default_timezone_get();
        ...
        $currentDate->setTime($currentDate->format('H'),
            $currentDate->format('i'), $currentDate->format("s"));
        ...
        for ($i = 0; $i < $this->maxIterationCount; $i++) {
            ...
            if ((!$allowCurrentDate && $nextRun == $currentDate) || --$nth > -1) {
                $this->fieldFactory->getField(self::$minPosition)->increment($nextRun, $invert, isset($parts[0]) ? $parts[0] : null);
                continue;
            }
